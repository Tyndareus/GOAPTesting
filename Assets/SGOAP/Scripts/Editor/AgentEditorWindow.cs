...
public class AgentEditorWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        pageScrollPosition = GUILayout.BeginScrollView(pageScrollPosition, GUILayout.Width(Screen.width), GUILayout.Height(Screen.height * 0.9f));
    ...
    public void DrawSimulator(Agent agent)
    {
        ...
        if (GUILayout.Button("Plan", GUILayout.Width(60)))
        {
